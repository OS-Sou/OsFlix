            ...
            <div class="col-12">
                <div class="header__content">
                    ...
                    <ul class="header__nav">
                        ...
                        <!-- dropdown -->
                        <li class="header__nav-item">
                            <a class="dropdown-toggle header__nav-link" href="#" role="button" id="dropdownMenuCatalog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $language->header->tv ?> <i class="icon ion-ios-arrow-down"></i></a>

                            <ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuCatalog">
                                <li><a href="/catalog/tv/0/1"><?= $language->header->view_all ?></a></li>
                                <?php foreach ($category['tv'] as $row) { ?>
                                    <li><a href="/catalog/tv/<?= $row->category_id ?>/1"><?= $row->category_name ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <!-- end dropdown -->
                        ...
                        <!-- dropdown -->
                        <li class="header__nav-item">
                            <a class="dropdown-toggle header__nav-link" href="#" role="button" id="dropdownMenuCatalog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $language->header->animes ?> <i class="icon ion-ios-arrow-down"></i></a>

                            <ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuCatalog">
                                <li><a href="/catalog/animes/0/1"><?= $language->header->view_all ?></a></li>
                                <?php foreach ($category['animes'] as $row) { ?>
                                    <li><a href="/catalog/animes/<?= $row->category_id ?>/1"><?= $row->category_name ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <!-- end dropdown -->
                        ...
                        <!-- dropdown -->
                        <li class="header__nav-item">
                            <a class="dropdown-toggle header__nav-link" href="#" role="button" id="dropdownMenuCatalog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $language->header->cartoons ?> <i class="icon ion-ios-arrow-down"></i></a>

                            <ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuCatalog">
                                <li><a href="/catalog/cartoons/0/1"><?= $language->header->view_all ?></a></li>
                                <?php foreach ($category['cartoons'] as $row) { ?>
                                    <li><a href="/catalog/cartoons/<?= $row->category_id ?>/1"><?= $row->category_name ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <!-- end dropdown -->
